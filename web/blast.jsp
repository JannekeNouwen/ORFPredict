...
<t:template_main>
    ...
    <form action="blast" method="post">
        ...
        <label for="organism">TaxID of a (group of) organism(s) you want to
            include / exclude:</label><br>
        <input type="text" id="organism" name="organism"
               pattern="[0-9]*"><br>
        <input type="radio" id="false" name="exclude" value="false">
        <label for="false">Include</label><br>
        <input type="radio" id="true" name="exclude" value="true">
        <label for="true">Exclude</label><br>
